...
<template>
  <!-- Navbar -->
  <Navbar :total="store.getProducts.count" />
  <div class="container">
    <!-- Filter -->
    <div class="row  mt-4">
      <div class="col-3">
        <label for="category" class="form-label">Categories: </label>
        <vSelect :options="categories" v-model="filter.category" id="category" label="title" :reduce="el => el.id"
          :get-option-label="(el) => el.title.ru" />
      </div>
      <div class="col-3">
